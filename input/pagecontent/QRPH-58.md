...
#### 3.58.4.1 Send Aggregate Report Request Message
...
<p id ="t3.58.4.1.2-1" class="tableTitle">Table 3.58.4.1.2-1: Messaging Semantics for Send Aggregate Report Request Message</p>
...
The Content Consumer **SHALL** process the mADX message received and return the status of the transaction as per section 3.58.4.2. .

##### 3.58.4.1.4 Send Aggregate Report Bundle Message
...
#### 3.58.4.2 Send Aggregate Report Response Message
...
<p id ="t3.58.4.2.2-1" class="tableTitle">Table 3.58.4.2.2-1: Send Aggregate Report Response Message status codes</p>
...
- The Send Aggregate Report Request Message does not adhere to the message semantics as defined in Section 3.58.4.1.2 Message Semantics.
